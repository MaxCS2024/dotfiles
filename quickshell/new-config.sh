...
layout_entries=(shell.qml bar battery calendar clipboard installer keybinds launcher lockscreen menu network notifications osd packages powermenu tests theme volume wallpaper weather)
